...
@section('content')
    ...
    <div class="row">
      ...
      @endif
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <a href="{!!route('district.create')!!}" class="btn btn-success waves-effect waves-light"><i
                                        class="mdi mdi-plus me-2"></i> Add New District</a>
        ...
        <td class="text-left">{{ $district->district }}</td>
        <td class="text-center">{{ $district->getUsers->name }}</td>

        <td  class="text-center" >
           
                <a  href="{{ route('district.edit',$district->id) }}"  rel="tooltip" title="Edit Task"class="btn btn-outline-dark waves-effect waves-light btn-sm">
                     Edit</a>
