            ...
            <ul class="metismenu list-unstyled" id="side-menu">
               ...
               <!-- <li>
                 ...
                 <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="uil-window-section"></i>
                        <span>@lang('translation.manage')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('users.index')}}">@lang('translation.users')</a></li>
                        <li><a href="{!!route('roles.index')!!}">@lang('translation.roles')</a></li>
                        <li><a href="ecommerce-orders">@lang('translation.banks')</a></li>
                        <li><a href="ecommerce-customers">@lang('translation.branches')</a></li>
